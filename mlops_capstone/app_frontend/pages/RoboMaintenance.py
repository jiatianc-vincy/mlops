...
with app_tab:
    ...
    data_file = st.text_input('Training Data File Path',key='data', value='/home/ubuntu/mlops/mlops_capstone/store/datasets/robot_maintenance/train.pkl')
    ...
    mlflow_tracking_uri = st.text_input('Tracking URI',key='uri', value='/home/ubuntu/mlops/mlops_capstone/store/models/robot_maintenance')
    ...
    scaler_destination = st.text_input('Scaler Destination',key='scalerdest', value= '/home/ubuntu/mlops/mlops_capstone/store/outputs/robot_maintenance') 
    ...
    if st.button('Run Maintenance Analysis', key='analysis'):
        ...
        INFERENCE_DATA = {'model_name':model_name, 'stage':stage, 'sample':sample, 
                'model_run_id':model_run_id, 'scaler_file_name':scaler_file_name, 'scaler_destination':scaler_destination}
        INFERENCE_RESPONSE = requests.post(url = INFERENCE_URL, json = INFERENCE_DATA)
